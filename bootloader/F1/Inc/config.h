...
#elif defined TARGET_DAPLINK_STM32F103C6
	#define LED1_CLOCK		RCC_APB2ENR_IOPBEN
	#define LED1_BIT_0
	#define LED1_BIT_1
	#define LED1_MODE		GPIOB->CRH = ( GPIOB->CRH & ~(GPIO_CRH_CNF8 | GPIO_CRH_MODE8 ) ) | GPIO_CRH_MODE8_1
	#define LED1_ON			WRITE_REG(GPIOB->BSRR, GPIO_BSRR_BS8)
	#define LED1_OFF		WRITE_REG(GPIOB->BRR, GPIO_BRR_BR8)

	#define LED2_CLOCK		RCC_APB2ENR_IOPBEN
	#define LED2_BIT_0
	#define LED2_BIT_1
	#define LED2_MODE		GPIOB->CRH = ( GPIOB->CRH & ~(GPIO_CRH_CNF12 | GPIO_CRH_MODE12 ) ) | GPIO_CRH_MODE12_1
	#define LED2_HIGH		WRITE_REG(GPIOB->BSRR, GPIO_BSRR_BS12)
	#define LED2_LOW		WRITE_REG(GPIOB->BRR, GPIO_BRR_BR12)

	// make PA6 pull up, drive to zero will enter bootloader
	#define DISC_CLOCK		RCC_APB2ENR_IOPAEN
	#define DISC_BIT_0		//SET_BIT(GPIOA->CRL, GPIO_CRL_CNF6_0 | GPIO_CRL_MODE6)
	#define DISC_BIT_1		WRITE_REG(GPIOA->ODR, GPIO_ODR_ODR6)
	#define DISC_MODE		GPIOA->CRL = ( GPIOA->CRL & ~(GPIO_CRL_CNF6 | GPIO_CRL_MODE6 ) ) | GPIO_CRL_CNF6_1
//	#define DISC_HIGH		WRITE_REG(GPIOA->BSRR, GPIO_BSRR_BS2)
//	#define DISC_LOW		WRITE_REG(GPIOA->BRR, GPIO_BRR_BR2)
#else
