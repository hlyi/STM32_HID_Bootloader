...
#define __CONFIG_H
  ...
  #define LED1_CLOCK		(RCC->APB2ENR |= RCC_APB2ENR_IOPAEN)
	...
	#define LED1_CLOCK		RCC_APB2ENR_IOPBEN
	#define LED1_BIT_0		SET_BIT(GPIOB->CRH, GPIO_CRH_CNF8_0 | GPIO_CRH_MODE8_1)
	#define LED1_BIT_1
	#define LED1_MODE
	...
	#define LED2_BIT_0		SET_BIT(GPIOB->CRH, GPIO_CRH_CNF12_0 | GPIO_CRH_MODE12_1)
	#define LED2_BIT_1
	#define LED2_MODE
	...
	#define DISC_BIT_1		SET_BIT(GPIOA->ODR, GPIO_ODR_ODR6)
	#define DISC_MODE		SET_BIT(GPIOA->CRL, GPIO_CRL_CNF6_1)
